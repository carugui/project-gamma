        ...
        <Window title="Sobre mí" size="medium" type='about' position='bottom-left' clickTo={onClose} content=
            {
                <div className='about-page'>
                    ...
                    <p>Aquí tienes mi <a href='../../public/documents/curriculum-carla-cardona.pdf' target='_blank'>curriculum</a>, y si estás interesado en el Diseño Gráfico aquí tienes mi <a href='../../public/documents/portfolio-laboral-carla-cardona.pdf' target='_blank'>portfolio de diseño</a>.</p>
